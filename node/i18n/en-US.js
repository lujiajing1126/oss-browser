module.exports = {
  ...
  "auth.presetOssPath.popup.msg1":
    'The current AK that has all Bucket rights does not need to set the "Preset OSS Path"',
  "auth.presetOssPath.popup.msg2":
    'The current AK only has the permissions of a Bucket or a certain path under a Bucket, you need to set the "Preset OSS Path"',
  ...
  "requestpay.popup.msg":
    "If your authorized bucket opens the request payer mode and you are not the owner of the bucket, you should check the 'Request Payer Mode'. The amount of traffic, requests, etc. that you generate when you visit the bucket will be paid by you. For details, please refer to the help documentation.",
  ...
  forbidden:
    "You cannot move the selected objects to the current path or across region",
  ...
  "acl.warn-not-private.public-read":
    "If your bucket ACL is <code>public read</code> anyone can access your bucket without prior authentication. We recommend that you set the Bucket ACL to Private. Exercise caution when setting bucket ACLs.",
  ...
  not_use_own_domain: "Not use other domains",
  custom_domain: "Other Domains",
